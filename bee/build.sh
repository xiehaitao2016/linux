...
export BUILD_DIR=/home/xiehaitao/work/opensource/test/bee/output
export CC=${CROSS_COMPILE}gcc
export KERNEL_PATH=/home/xiehaitao/work/opensource/runninglinuxkernel_5.0

bee_make()
{
	echo $MAKE_PROCESS
	make $MAKE_PROCESS beetools $KERNEL_PATH $2
